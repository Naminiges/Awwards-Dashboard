    ...
    <div class="container mx-auto p-4">
        ...
        <form action="/items" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="tags" id="tags" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Masukkan tags, pisahkan dengan koma">
            </div>
